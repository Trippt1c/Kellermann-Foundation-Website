...
// Find User by Search
// selected columns(title and amount) are not part of donors or orgs so probably change donors to orgGrants
...
exports.create = (req, res) => {
  ...
  // User the connection
  connection.query(
    "INSERT INTO orgs VALUES (org_name = ?, type = ?, contact_name = ?, email = ?, comments = ?)",
    [org_name, type, contact_name, email, comments],
    (err, rows) => {
      if (!err) {
